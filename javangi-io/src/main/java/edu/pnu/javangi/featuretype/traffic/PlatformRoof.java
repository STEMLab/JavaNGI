...
public class PlatformRoof extends AbstractFeatureType { // 승강장의 지붕 A0201222
	...
	public PlatformRoof(){
		...
		metaDataTableName = "platformroofmetadata";
		dataTableName = "platformroofdata";
	}
	
	public PlatformRoof(int layerID, String layerName){
