...
public class Stop extends AbstractFeatureType{  // 정류장 A0140000
	...
	public Stop(){
		...
		metaDataTableName = "stopmetadata";
		dataTableName = "stopdata";
	}
	
	public Stop(int layerID, String layerName){
