...
public class TrafficSign extends AbstractFeatureType{   // 표지 C0410000
	...
	public TrafficSign(){
		...
		metaDataTableName = "trafficsignmetadata";
		dataTableName = "trafficsigndata";
	}
	
	public TrafficSign(int layerID, String layerName){
	...
	public String[] getInsertQuery(String fileName) {
		...
		for(int i=0; i<recordID.size(); i++){
			query = "insert into " + dataTableName + " values('" + fileName + "', " + layerID + ", " + recordID.get(i) + ", '"
					+ purpose.get(i) + "', '" + UFID.get(i) + "', " + wkts.get(i) + ", '" + gattrs.get(i) + "')";
