...
public class FishFarm extends AbstractFeatureType{      // 양식장 C0130000
	...
	public FishFarm(){
		...
		metaDataTableName = "fishfarmmetadata";
		dataTableName = "fishfarmdata";
	}
	
	public FishFarm(int layerID, String layerName){
