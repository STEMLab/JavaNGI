...
public class Wharf extends AbstractFeatureType{ // �ε� C0025336
	...
	public Wharf(){
		...
		metaDataTableName = "wharfmetadata";
		dataTableName = "wharfdata";
	}
	
	public Wharf(int layerID, String layerName){
	...
	public int getNumManagementeAgency(){
	...
	public String[] getInsertQuery(String fileName) {
		...
		for(int i=0; i<recordID.size(); i++){
			query = "insert into " + dataTableName + " values('" + fileName + "', " + layerID + ", " + recordID.get(i) + ", '"
					+ purpose.get(i) + "', '" + material.get(i) + "', '" + managementAgency.get(i) + "', '" + UFID.get(i) + "', "
