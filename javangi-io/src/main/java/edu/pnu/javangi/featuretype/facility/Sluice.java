...
public class Sluice extends AbstractFeatureType{        // 수문 C0060000
	...
	public Sluice(){
		...
		metaDataTableName = "sluicemetadata";
		dataTableName = "sluicedata";
	}
	
	public Sluice(int layerID, String layerName){
