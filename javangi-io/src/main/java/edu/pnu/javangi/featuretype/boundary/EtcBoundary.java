package edu.pnu.javangi.featuretype.boundary;
...
public class EtcBoundary extends AbstractFeatureType{ // 기타경계		G0030000
	...
	public EtcBoundary(){
		...
		metaDataTableName = "etcboundarymetadata";
		dataTableName = "etcboundarydata";
	}
	
	public EtcBoundary(int layerID, String layerName){
