...
public class BankingCutting extends AbstractFeatureType{        // 성/절토 F0030000
	...
	public BankingCutting(){
		...
		metaDataTableName = "bankingcuttingmetadata";
		dataTableName = "bankingcuttingdata";
	}
	
	public BankingCutting(int layerID, String layerName){
	...
	public String[] getInsertQuery(String fileName) {
		...
		for(int i=0; i<recordID.size(); i++){
			query = "insert into " + dataTableName + " values('" + fileName + "', " + layerID + ", " + recordID.get(i) + ", '"
					+ classification.get(i) + "', '" + topBottom.get(i) + "', '"
	...
	public String[] getCreateSchema() {
		...
		schema[1] = "CREATE TABLE IF NOT EXISTS " + dataTableName + "(  "
				...
				+ "classification text, topbottom text, "
