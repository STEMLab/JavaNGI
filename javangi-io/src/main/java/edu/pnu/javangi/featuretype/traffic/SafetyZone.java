...
public class SafetyZone extends AbstractFeatureType { // �������� A0053326
	...
	public SafetyZone(){
		...
		metaDataTableName = "safetyzonemetadata";
		dataTableName = "safetyzonedata";
	}
	
	public SafetyZone(int layerID, String layerName){
	...
	public String[] getInsertQuery(String fileName) {
		...
		for(int i=0; i<recordID.size(); i++){
			query = "insert into " + dataTableName + " values('" + fileName + "', " + layerID + ", " + recordID.get(i) + ", '"
					+ "', '" + structure.get(i) + "', '" + name.get(i) + "', '" + UFID.get(i) + "', "
