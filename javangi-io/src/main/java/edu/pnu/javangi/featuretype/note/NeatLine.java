...
public class NeatLine extends AbstractFeatureType{      // 도곽선 H0010000
	...
	public NeatLine(){
		...
		metaDataTableName = "neatlinemetadata";
		dataTableName = "neatlinedata";
	}
	
	public NeatLine(int layerID, String layerName){
